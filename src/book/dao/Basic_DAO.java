...
public abstract class Basic_DAO<T> {
    ...
    protected Connection getConn(){
        return JDBC_C3P0.get_connection();
    }
    ...
    protected int executeUpdate(String sql , Object... params) {
        ...
        try{
            ...
            e.printStackTrace();
            throw new RuntimeException("BaseDAO executeUpdate出错了");
        }finally {
            JDBC_C3P0.close(conn,null,null);
        }
    }
    ...
    protected Object[] executeComplexQuery(String sql , Object... params){
        ...
        try{
            ...
            e.printStackTrace();
            throw new RuntimeException("BaseDAO executeComplexQuery出错了");
        }
    ...
    protected T load(String sql , Object... params){
        ...
        try{
            ...
            e.printStackTrace();
            throw new RuntimeException("BaseDAO load出错了");
        }finally {
            JDBC_C3P0.close(conn,rs,psmt);
        }
    ...
    protected List<T> executeQuery(String sql , Object... params){
        ...
        try{
            ...
            e.printStackTrace();
            throw new RuntimeException("BaseDAO executeQuery出错了");
        }finally {
            JDBC_C3P0.close(conn,rs,psmt);
        }
        return list ;
